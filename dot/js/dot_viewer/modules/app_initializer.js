 ...
 */
import {
    templateSelect, codeInput, notationRadios, toggleAllPanelsBtn, toggleSettingsPanelBtn, settingsPanel,
...
import {
    setupAllPanelsToggle, setupSettingsPanelToggle, setupFullscreenToggle, setupClearCodeButton,
...
export async function initializeApp() {
    try {
        ...
        if (toggleSettingsPanelBtn && settingsPanel) {
            const settingsPanelContent = settingsPanel.querySelector('.settings-content');
            if (settingsPanelContent) setupSettingsPanelToggle(toggleSettingsPanelBtn, settingsPanelContent);
        }
